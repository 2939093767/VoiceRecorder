    ...
    , m_records()
{
    ...
    connect(m_cloudLlm, &CloudLLM::streamReceived, this, &MeetingSummaryPage::onStreamReceived);
    connect(m_cloudLlm, &CloudLLM::finished, this, &MeetingSummaryPage::onLlmFinished);
    connect(m_cloudLlm, &CloudLLM::errorOccurred, this, &MeetingSummaryPage::onLlmError);
...
QString MeetingSummaryPage::formatRecordsForDisplay(const QList<RecordItem> &records)
{
    QString result;
